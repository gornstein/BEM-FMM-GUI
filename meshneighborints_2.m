function [EC] = meshneighborints_2(P, t, normals, Area, Center, RnumberE, ineighborE)
%   Accurate integration for electric field/electric potential on neighbor facets
%   Copyright WAW 2020-2021
    N = size(t, 1);
    ...
    disp(['  Analytical integrals computed in ' num2str(toc) ' s']);
    ...
    disp(['  Correction matrix EC computed in ' num2str(toc) ' s']);
end