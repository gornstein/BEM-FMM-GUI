...
switch app.CrossSectionControlsTabGroup.SelectedTab.Title
    case 'XY Plane'
        ...
        bemplot_2D_niftiCrossSection(app.CrossSectionDisplay, app.niftidata.VT1, app.niftidata.info, 'xy', Z*1e-2);
    ...
    case 'XZ Plane'
        ...
        obs = bemfmm_makeObsPlane(planeNormal, planeCenter, planeUp, planeHeight, planeWidth, pointDensity);
        bemplot_2D_niftiCrossSection(app.CrossSectionDisplay, app.niftidata.VT1, app.niftidata.info, 'xz', Y*1e-2);
        brighten(app.CrossSectionDisplay, 0.3);
        bemplot_2D_modelIntersections(app.CrossSectionDisplay, model, obs); %   Check these things
    ...
    case 'YZ Plane'
        ...
        pointDensity = 300/planeWidth;
        obs = bemfmm_makeObsPlane(planeNormal, planeCenter, planeUp, planeHeight, planeWidth, pointDensity);
        bemplot_2D_niftiCrossSection(app.CrossSectionDisplay, app.niftidata.VT1, app.niftidata.info, 'yz', X*1e-2);
        brighten(app.CrossSectionDisplay, 0.3);
        bemplot_2D_modelIntersections(app.CrossSectionDisplay, model, obs); %   Check these things
