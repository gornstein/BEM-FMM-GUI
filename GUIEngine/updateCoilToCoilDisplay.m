...
[app.CoilDisplayObjects.coilpatch, app.CoilDisplayObjects.coilNormalLine, app.CoilDisplayObjects.coilFieldLine] = displaycoil(app.CoilDisplay, coil, matrix, coilNormal, coilField);
