function obs = bemfmm_makeObsPlaneAllPlanes(planeNormalR, planeCenterR, planeUpR, planeHeightR, planeWidthR, pointDensityR, n)
    
    % Get rid of for loop recursiveness
    planeNormal = planeNormalR(n,:);
    planeCenter = planeCenterR(n,:);
    planeUp = planeUpR(n,:);
    planeHeight = planeHeightR(n);
    planeWidth = planeWidthR(n);
    pointDensity = pointDensityR(n);
